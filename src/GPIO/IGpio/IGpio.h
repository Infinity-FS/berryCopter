...
class IGpio {
 public:
	...
	int readI2CRegisterByte (unsigned int t_deviceHandleID, unsigned int t_RegAddr);

	int writeI2CRegisterByte (unsigned int t_deviceHandleID, unsigned int t_RegAddr, unsigned int t_byte);
};
