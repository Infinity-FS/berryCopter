...
int I2CDevice::readRegister(unsigned int t_regAddr, unsigned int* t_byte) {
	unsigned int readByte = (this->IGpioInstance).readI2CRegisterByte(this->I2CHandleID, t_regAddr, t_buffer);
...
int I2CDevice::writeRegister(unsigned int t_regAddr, unsigned int* t_byte) {
	int result = (this->IGpioInstance).readI2CRegisterByte(this->I2CHandleID, t_regAddr, t_byte);
