...
MPU6050::MPU6050(int t_AccelerometerRange_G, int t_GyrometerRange, IGpio &t_IGpioInstance) :
        ...
        Accelerometer(t_AccelerometerRange_G, 16, 1000, 10, (int) (0.0025 * ((double) pow(2, 15) /
                                                                             (double) t_AccelerometerRange_G))), // 0.25 % of G max noise
        Gyrometer(t_GyrometerRange, 2000, 1000, 10,
                  (int) (0.25 * ((double) pow(2, 15) / (double) t_GyrometerRange))) //25 % 1 deg/sec max noise
{
}
...
Vector3<double> MPU6050::getGyrometerVector3_deg_s() {
    double oneDeg_s = (double) pow(2, 15) / (double) this->getGyrometerRange();

    Vector3<double> deg_s = Vector3<double>();
    deg_s.X =  (double) this->gyrometerVector3.X / oneDeg_s;
    deg_s.Y =  (double) this->gyrometerVector3.Y / oneDeg_s;
    deg_s.Z =  (double) this->gyrometerVector3.Z / oneDeg_s;
